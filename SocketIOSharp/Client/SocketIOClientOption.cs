...
namespace SocketIOSharp.Client
{
    public class SocketIOClientOption : EngineIOClientOption
    {
        ...
        public SocketIOClientOption(EngineIOScheme Scheme,
                                    string Host,
                                    ushort Port,
                                    ushort PolicyPort = 843,
                                    string Path = "/socket.io",
                                    bool Reconnection = true,
                                    ulong ReconnectionAttempts = ulong.MaxValue,
                                    int ReconnectionDelay = 1000,
                                    int ReconnectionDelayMax = 5000,
                                    double RandomizationFactor = 0.5,
                                    IDictionary<string, string> Query = null,
                                    bool Upgrade = true,
                                    bool RemeberUpgrade = false,
                                    bool ForceBase64 = false,
                                    bool WithCredentials = true,
                                    bool? TimestampRequests = null,
                                    ...
                                    LocalCertificateSelectionCallback ClientCertificateSelectionCallback = null,
